...
var awsConsumedOperands = map[string][]string{
	...
	"cloudwatch":     {"dimensions", "evaluation_periods", "notification_channel", "period_seconds", "region", "statistic", "treat_missing_data"},
	...
	"redshiftserverless":     {"kms_key_id", "securityGroupIds", "subnetIds"},
