...
var azureCertifyServices = []string{"loadbalancer", "changefeed", "vnet", "blob", "containerapps",
	"flexpostgres", "servicebusqueue", "servicebustopic", "keyvault", "rediscache", "dnszone", "dnsrecord", "roleassignment", "customroledef", "metricalert", "portaldash", "webtest", "scheduledquery", "acr", "azurefiles", "cosmos", "aisearch", "eventhubs", "azkafka", "frontdoorwaf", "azurecdn", "apim", "containerappsjob", "managedidentity", "keyvaultkey", "consumptionbudget", "loganalytics", "activitylog", "defender", "azureopenai", "aks", "aks-addon", "aks-workloadidentity", "backuppolicy", "acsemail", "backupvault", "azvm", "azdisk", "azimage"}
