...
func (d *Driver) serviceDiscoverers() map[string]func(string) ([]provider.Discovered, []string, error) {
	return map[string]func(string) ([]provider.Discovered, []string, error){
		...
		"gce": d.discoverGCEInstances, "pd": d.discoverPD, "computeimage": d.discoverGCPImages, "mig": d.discoverMIGs, "artifactregistry": d.discoverArtifactRegistries, "loadbalancer": d.discoverLoadBalancers,
